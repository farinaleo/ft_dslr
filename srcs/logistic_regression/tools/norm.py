...
def denorm_thetas(thetas: list[float], mean_x: float, std_x: float, mean_y: float, std_y: float) -> list[float]:
    """
    ...
    """
    t1 = thetas[1] * (std_y / std_x)
    t0 = mean_y + std_y * (thetas[0] - (thetas[1] * (mean_x / std_x)))
