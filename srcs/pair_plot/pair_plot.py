...
def pair_plot(df: pd.DataFrame, verbose: bool = False) -> None:
    ...
    fig, axes = plt.subplots(nrows=y_size, ncols=x_size, squeeze=False, sharex=False, sharey=False, figsize=(20, 20))
...
def plot_single_graph(df: pd.DataFrame, x_cols: list, y_cols: list, fig: plt.Axes, x: int, y: int) -> None:
    """
